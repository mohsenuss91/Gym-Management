...
public class Instruments_del extends javax.swing.JFrame implements ActionListener {

	
	public Instruments_del() {
		initComponents();
	}
	...
	private void initComponents() {
		...
		jLabel1.setText("Add Instruments");
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if(ae.getSource()==jButton1)
		{
			...
			MongoClient mongo;
			try {
				float b=Float.parseFloat(jLabel8.getText());
				b-=1;
				String s=Float.toString(b);
				jLabel8.setText(s);
				BasicDBObject newDocument = new BasicDBObject();
				newDocument.append("$set",new BasicDBObject().append("Bench",b));
				BasicDBObject searchQuery = new BasicDBObject();	
				mongo = new MongoClient("localhost", 27017);
				DB db = mongo.getDB("Gym");
				DBCollection Instruments = db.getCollection("Instruments");
				Instruments.update(searchQuery, newDocument); 
			} catch (UnknownHostException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}	
		...
		{	 
			MongoClient mongo;
			try {
				float b=Float.parseFloat(jLabel9.getText());
				b-=1;
				String s=Float.toString(b);
				jLabel9.setText(s);
				BasicDBObject newDocument = new BasicDBObject();
				newDocument.append("$set",new BasicDBObject().append("Barbell",b));
				BasicDBObject searchQuery = new BasicDBObject();
				mongo = new MongoClient("localhost", 27017);
				DB db = mongo.getDB("Gym");
				DBCollection Instruments = db.getCollection("Instruments");
		...
		{	 
			MongoClient mongo;
			try {
				float b=Float.parseFloat(jLabel10.getText());
				b-=1;
				String s=Float.toString(b);
				jLabel10.setText(s);
				BasicDBObject newDocument = new BasicDBObject();
				newDocument.append("$set",new BasicDBObject().append("Dumbbell",b));
				BasicDBObject searchQuery = new BasicDBObject();
				mongo = new MongoClient("localhost", 27017);
				DB db = mongo.getDB("Gym");
				DBCollection Instruments = db.getCollection("Instruments");
		...
		{	 
			MongoClient mongo;
			try {
				float b=Float.parseFloat(jLabel11.getText());
				b-=1;
				String s=Float.toString(b);
				jLabel11.setText(s);
				BasicDBObject newDocument = new BasicDBObject();
				newDocument.append("$set",new BasicDBObject().append("PowerRack",b));
                BasicDBObject searchQuery = new BasicDBObject();				
				mongo = new MongoClient("localhost", 27017);
				DB db = mongo.getDB("Gym");
				DBCollection Instruments = db.getCollection("Instruments");
		...
		{	 
			MongoClient mongo;
			try {
				float b=Float.parseFloat(jLabel12.getText());
				b-=1;
				String s=Float.toString(b);
				jLabel12.setText(s);
				BasicDBObject newDocument = new BasicDBObject();
				newDocument.append("$set",new BasicDBObject().append("Trademill",b));
				BasicDBObject searchQuery = new BasicDBObject();
				mongo = new MongoClient("localhost", 27017);
				DB db = mongo.getDB("Gym");
				DBCollection Instruments = db.getCollection("Instruments");
		...
		{	 
			MongoClient mongo;
			try {
				float b=Float.parseFloat(jLabel13.getText());
				b-=1;
				String s=Float.toString(b);
				jLabel13.setText(s);
				BasicDBObject newDocument = new BasicDBObject();
				newDocument.append("$set",new BasicDBObject().append("Pulley",b));
				BasicDBObject searchQuery = new BasicDBObject();
