...
public class Receptionist extends javax.swing.JFrame implements ActionListener {
	...
	public Receptionist(String head) {
		Receptionist.head = head;
	}
	...
	private void initComponents() {
		...
		jLabel2.setText("HELLO " + head.toUpperCase() + " ");
		jLabel2.setBounds(135, 30, 240, 70);
		add(jLabel2);
		...
		jButton4.setBounds(20, 20, 100, 40);
		add(jButton4);
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(Receptionist.class.getName())
